...
class ApplyForm(forms.ModelForm):
	class Meta():
		...
		widgets = {
			'from_date':forms.TextInput(attrs={'class':'form-control datetimepicker-input','data-target':'#datetimepicker1'}),
			'applied_on':forms.TextInput(attrs={'class':'form-control',}),
			'to_date':forms.TextInput(attrs={'class':'form-control datetimepicker-input','data-target':'#datetimepicker2'}),
