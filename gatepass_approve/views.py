...
"BH2 Warden","BH3 Warden","GH Warden","BH1 Assistant Warden","BH2 Assistant Warden","BH3 Assistant Warden",\
"GH Assistant Warden"]
@login_required
def index(request):
	...
	if request.user.is_authenticated:
		...
		if prof.user_type in authorize_users:
			...
			if prof.user_type=="BH1 Supervisor":
				pending_passes=Gatepass.objects.all().filter(hostel_supervisor="Pending").filter(hostel="BH1(Arawali Hostel)")
			elif prof.user_type=="BH1 Warden":
				pending_passes=Gatepass.objects.all().filter(hostel_warden="Pending").filter(hostel="BH1(Arawali Hostel)")
			elif prof.user_type=="BH1 Assistant Warden":
				pending_passes=Gatepass.objects.all().filter(hostel_assistant_warden="Pending").filter(hostel="BH1(Arawali Hostel)")
			elif prof.user_type=="BH2 Supervisor":
				pending_passes=Gatepass.objects.all().filter(hostel_supervisor="Pending").filter(hostel="BH2(Nilgiri Hostel)")
			elif prof.user_type=="BH2 Warden":
				pending_passes=Gatepass.objects.all().filter(hostel_warden="Pending").filter(hostel="BH2(Nilgiri Hostel)")
			elif prof.user_type=="BH2 Assistant Warden":
				pending_passes=Gatepass.objects.all().filter(hostel_assistant_warden="Pending").filter(hostel="BH2(Nilgiri Hostel)")
			elif prof.user_type=="BH3 Supervisor":
				pending_passes=Gatepass.objects.all().filter(hostel_supervisor="Pending").filter(hostel="BH3(Shivalik Hostel)")
			elif prof.user_type=="BH3 Warden":
				pending_passes=Gatepass.objects.all().filter(hostel_warden="Pending").filter(hostel="BH3(Shivalik Hostel)")
			elif prof.user_type=="BH3 Assistant Warden":
				pending_passes=Gatepass.objects.all().filter(hostel_assistant_warden="Pending").filter(hostel="BH3(Shivalik Hostel)")
			elif prof.user_type=="GH Supervisor":
				pending_passes=Gatepass.objects.all().filter(hostel_supervisor="Pending").filter(hostel="GH(Gangotri Hostel)")
			elif prof.user_type=="GH Warden":
				pending_passes=Gatepass.objects.all().filter(hostel_warden="Pending").filter(hostel="GH(Gangotri Hostel)")
			elif prof.user_type=="GH Assistant Warden":
				pending_passes=Gatepass.objects.all().filter(hostel_assistant_warden="Pending").filter(hostel="GH(Gangotri Hostel)")
...
def approved_list(request):
	if request.user.is_authenticated:
		...
		if prof.user_type in authorize_users:
			...
			if prof.user_type=="BH1 Supervisor":
				approved_passes=Gatepass.objects.all().filter(hostel_supervisor="Approved").filter(hostel="BH1(Arawali Hostel)")
			elif prof.user_type=="BH1 Warden":
				approved_passes=Gatepass.objects.all().filter(hostel_warden="Approved").filter(hostel="BH1(Arawali Hostel)")
			elif prof.user_type=="BH1 Assistant Warden":
				approved_passes=Gatepass.objects.all().filter(hostel_assistant_warden="Approved").filter(hostel="BH1(Arawali Hostel)")
			elif prof.user_type=="BH2 Supervisor":
				approved_passes=Gatepass.objects.all().filter(hostel_supervisor="Approved").filter(hostel="BH2(Nilgiri Hostel)")
			elif prof.user_type=="BH2 Warden":
				approved_passes=Gatepass.objects.all().filter(hostel_warden="Approved").filter(hostel="BH2(Nilgiri Hostel)")
			elif prof.user_type=="BH2 Assistant Warden":
				approved_passes=Gatepass.objects.all().filter(hostel_assistant_warden="Approved").filter(hostel="BH2(Nilgiri Hostel)")
			elif prof.user_type=="BH3 Supervisor":
				approved_passes=Gatepass.objects.all().filter(hostel_supervisor="Approved").filter(hostel="BH3(Shivalik Hostel)")
			elif prof.user_type=="BH3 Warden":
				approved_passes=Gatepass.objects.all().filter(hostel_warden="Approved").filter(hostel="BH3(Shivalik Hostel)")
			elif prof.user_type=="BH3 Assistant Warden":
				approved_passes=Gatepass.objects.all().filter(hostel_assistant_warden="Approved").filter(hostel="BH3(Shivalik Hostel)")
			elif prof.user_type=="GH Supervisor":
				approved_passes=Gatepass.objects.all().filter(hostel_supervisor="Approved").filter(hostel="GH(Gangotri Hostel)")
			elif prof.user_type=="GH Warden":
				approved_passes=Gatepass.objects.all().filter(hostel_warden="Approved").filter(hostel="GH(Gangotri Hostel)")
			elif prof.user_type=="GH Assistant Warden":
				approved_passes=Gatepass.objects.all().filter(hostel_assistant_warden="Approved").filter(hostel="GH(Gangotri Hostel)")
			elif prof.user_type=="Control Room":
...
def rejected_list(request):
	if request.user.is_authenticated:
		...
		if prof.user_type in authorize_users:
			...
			if prof.user_type=="BH1 Supervisor":
				rejected_passes=Gatepass.objects.all().filter(hostel_supervisor="Rejected").filter(hostel="BH1(Arawali Hostel)")
			elif prof.user_type=="BH1 Warden":
				rejected_passes=Gatepass.objects.all().filter(hostel_warden="Rejected").filter(hostel="BH1(Arawali Hostel)")
			elif prof.user_type=="BH1 Assistant Warden":
				rejected_passes=Gatepass.objects.all().filter(hostel_assistant_warden="Rejected").filter(hostel="BH1(Arawali Hostel)")
			elif prof.user_type=="BH2 Supervisor":
				rejected_passes=Gatepass.objects.all().filter(hostel_supervisor="Rejected").filter(hostel="BH2(Nilgiri Hostel)")
			elif prof.user_type=="BH2 Warden":
				rejected_passes=Gatepass.objects.all().filter(hostel_warden="Rejected").filter(hostel="BH2(Nilgiri Hostel)")
			elif prof.user_type=="BH2 Assistant Warden":
				rejected_passes=Gatepass.objects.all().filter(hostel_assistant_warden="Rejected").filter(hostel="BH2(Nilgiri Hostel)")
			elif prof.user_type=="BH3 Supervisor":
				rejected_passes=Gatepass.objects.all().filter(hostel_supervisor="Rejected").filter(hostel="BH3(Shivalik Hostel)")
			elif prof.user_type=="BH3 Warden":
				rejected_passes=Gatepass.objects.all().filter(hostel_warden="Rejected").filter(hostel="BH3(Shivalik Hostel)")
			elif prof.user_type=="BH3 Assistant Warden":
				rejected_passes=Gatepass.objects.all().filter(hostel_assistant_warden="Rejected").filter(hostel="BH3(Shivalik Hostel)")
			elif prof.user_type=="GH Supervisor":
				rejected_passes=Gatepass.objects.all().filter(hostel_supervisor="Rejected").filter(hostel="GH(Gangotri Hostel)")
			elif prof.user_type=="GH Warden":
				rejected_passes=Gatepass.objects.all().filter(hostel_warden="Rejected").filter(hostel="GH(Gangotri Hostel)")
			elif prof.user_type=="GH Assistant Warden":
				rejected_passes=Gatepass.objects.all().filter(hostel_assistant_warden="Rejected").filter(hostel="GH(Gangotri Hostel)")
			elif prof.user_type=="Control Room":
...
def gatepass_detail(request,id):
	...
	if pass_detail.hostel=="BH1(Arawali Hostel)" and (prof.user_type in ["BH1 Supervisor","BH1 Warden","BH1 Assistant Warden"])  \
	or pass_detail.hostel=="BH2(Nilgiri Hostel)" and (prof.user_type in ["BH2 Supervisor","BH2 Warden","BH2 Assistant Warden"]) \
	or pass_detail.hostel=="BH3(Shivalik Hostel)" and (prof.user_type in ["BH3 Supervisor","BH3 Warden","BH3 Assistant Warden"]) \
	or pass_detail.hostel=="GH(Gangotri Hostel)" and (prof.user_type in ["GH Supervisor","GH Warden","GH Assistant Warden"])\
